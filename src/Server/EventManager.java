...
public class EventManager implements Serializable{	
	...
	private void displayLoadBalancer(){
		switch(loadBalancingAlg){
			case 0: System.out.println("Load balancer set to: roundRobinLoadBalancer");
			break;
			case 1: System.out.println("Load balancer set to: queueLengthLoadBalancer");
			break;
			case 2: System.out.println("Load balancer set to: fittingCpuShareLoadBalancer");
			break;
			case 3: System.out.println("Load balancer set to: minCpuShareLoadBalancer");
			break;
			case 4: System.out.println("Load balancer set to: minCpuLoadQueueBalancer");
			break;
			default: System.out.println("Load balancer set to: roundRobinLoadBalancer");
			break;
		}
	}
	/**
	...
	public Account getAccount(int accountID, InetAddress location, 
		...
		synchronized(this){
			newAccount = new Account(nextAccountID++, location, portNumber,
					accountType);
	...
	private class EventPublisher implements Runnable{
		...
		public Account loadBalancer(Message message){
			switch(loadBalancingAlg){
				case 0: return roundRobinLoadBalancer(message);
				case 1: return queueLengthLoadBalancer(message);
				case 2: return fittingCpuShareLoadBalancer(message);
				case 3: return minCpuShareLoadBalancer(message);
				case 4: return minCpuLoadQueueBalancer(message);
				default:
